		...
		if($tipe_file == "image/jpeg" || $tipe_file == "image/png"){
		  if($ukuran_file <= 1000000){ 
			if(move_uploaded_file($tmp_file, $path)){ 
			  ...
			  $query = "insert into `applicant_job` (`jobname`, `requirement`, `close_date`, `img`, `status`) values('".$jobname."','".$req."','".$close_date."','".$path."','Active')";
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="d-sm-flex justify-content-between align-items-center">
									<h2>Loker</h2>
									<button style="margin-bottom:20px" data-toggle="modal" data-target="#myModal" class="btn btn-info col-md-2"><span class="glyphicon glyphicon-plus"></span>Tambah Loker Baru</button>
                                </div>
                                    <div class="data-tables datatable-dark">
										 <table id="dataTable3" class="display" style="width:100%"><thead class="thead-dark">
													...
													<form action="index.php" method="post" enctype="multipart/form-data" >
														...
														<div class="dropdown-menu">
														  <input type="button" class="dropdown-item" data-toggle="modal" data-target="#activejob<?php echo $idjob ?>" value="Edit" \>
															<input type="hidden" name="idjobku" value="<?php echo $idjob ?>">
																	...
																	<div class="modal-body">
																		<form action="index.php" method="post" enctype="multipart/form-data" >
																			...
																			<div class="form-group">
																				...
																				<input type="hidden" name="editjobku" value="<?php echo $idjob; ?>">
																			</div>
											...
											if(isset($_POST["hapus1"])){
													$hapusin = mysqli_query($conn,"delete from applicant_job where id='".$_POST['idjobku']."'");
													if($hapusin){
														// unlink($gamber);
											...
											if(isset($_POST["simpan2"])){
												...
												$editdate = $_POST['editdate'];
													$simpanin = mysqli_query($conn,"update applicant_job set jobname='$editjob', requirement='$editreq', close_date='$editdate' where id='".$_POST['editjobku']."'");
													if($simpanin){
