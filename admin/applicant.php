    ...
    <div class="page-container">
        ...
        <div class="sidebar-menu">
            <div class="sidebar-header">
                    <a href="index.php"><img src="../sanjaya-logo.png" alt="logo" width="100%"></a>
            </div>
            <div class="main-menu">
                <div class="menu-inner">
                    <nav>
                        <ul class="metismenu" id="menu">
                            <li>
                                <a href="index.php"><i class="ti-dashboard"></i><span>Kelola Loker</span></a>
                            </li>
							<li class="active">
                                <a href="applicant.php"><i class="ti-dashboard"></i><span>Kelola Pelamar</span></a>
                            </li>
							<li>
                                <a href="scheduling.php"><i class="ti-dashboard"></i><span>Jadwal Interview</span></a>
                            </li>
                            <li>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="d-sm-flex justify-content-between align-items-center">
									<h2>Data Pelamar (Belum Diproses)</h2>
											...
											if(isset($_POST["schedule"])){
													...
													$intview = mysqli_query($conn,"insert into applicant_scheduling values('','$ids','$alamat','$tanggal','$pic','$telp');");
														if($intview){
																...
																$mail->Subject = 'Hi, ' . $nama1 . '! Undangan Interview untuk posisi '.$posisi1.' di CV.Sanjaya Gemilang Banjarnegara';
																// Mengatur format email ke HTML
																$mail->isHTML(true);
																// Konten/isi email
																$mailContent = '
																	<h1>Selamat!!!</h1>
																	<h3>Kami ingin mengucapkan terima kasih atas minat Anda dalam melamar posisi '.$posisi1.' di CV.Sanjaya Gemilang Banjarnegara. Setelah meninjau CV dengan cermat, kami senang untuk mengundang Anda untuk mengikuti tahap wawancara.
																	</h3>
																	<h4>Berikut detail wawancara:</h4>
																	<br \>
																	<table><strong>
																	<tr>
																		<td>Tanggal</td>
																	...
																	<br \><br \>
																	<br \> Mohon datang dengan membawa lamaran kerja Anda dan berkas pendukung lainnya.
																	
																	Apabila anda berkendala tidak dapat hadir, anda bisa menghubungi kontak PIC yang tertera untuk konfirmasi pembatalan interview.
																	Kami sangat menantikan pertemuan dengan Anda dan berharap Anda akan menjadi bagian dari tim kami. Terima kasih atas kesempatan ini dan selamat atas pencapaian Anda.
                ...
                <div class="row mt-5 mb-5">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <div class="d-sm-flex justify-content-between align-items-center">
									<h2>Data Pelamar (Sudah Diproses)</h2>
