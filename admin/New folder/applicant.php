													...
													$intview = mysqli_query($conn,"insert into applicant_scheduling values('','$ids','$alamat','$tanggal','$pic','$telp');");
														if($intview){
																...
																$mailContent = '
																	...
																	<br \><br \>
																	<br \>Mohon konfirmasi kehadiran Anda dalam wawancara ini dengan menghubungi PIC yang telah tercantum paling lambat 2 hari dihitung setelah email ini diterima.
																	Mohon datang dengan membawa salinan lamaran kerja Anda dan berkas pendukung lainnya.
