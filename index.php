...
<html>
    ...
    <body style="font-family:verdana">
        ...
        <div class="wraper">
            ...
            <!-- header end -->
            <!-- slider start -->
            <div style="background-image:url('tl.png');background-repeat:no-repeat; width:100%; height:300px;">
            </div>    
            <div class="container-fluid text-center">
                    <div class="slider-text" style="margin-top:1%; margin-left:80%;">
                        <a href="admin">Login admin</a>
                        <a href="apply.php">Lamar</a>
                ...
                <div class="container-fluid">
					...
					if (mysqli_fetch_array($sql)>0) {
						...
						while ($row = mysqli_fetch_assoc($sql)) {
							if ($i++ % 4 == 0 || $i++ <1) echo "<div class='row'>";
					?>    
